            ...
            >
                ...
                >
                    ...
                    <div className='h-4/5 gap-10 flex flex-col'>
                        ...
                        <Link to="/buscar"
                            class="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-[10px] p-1.5 text-white bg-primary transition-[background-color] duration-[400ms] hover:bg-secondary"
                        >
                    ...
                    <div className=' h-1/5 flex flex-col justify-end'>
                        ...
                        >
                            ...
                            <img src={logo_personas} alt="personas" className='transition-[width] duration-[300ms] w-[90%] group-hover:w-[100%]'/>
                        </Link>
                    </div>
