...
import problematic1Picture from './assets/problematic-1.png'
import problematic2Picture from './assets/problematic-2.png'
import problematic3Picture from './assets/problematic-3.png'
import problematic4Picture from './assets/problematic-4.png'
  ...
  return (
    <div className='problematic-container' id='problematic'>
      ...
      className='problematic__cards-container'>
          <div className='problematic__card'><Card modifier='1' icon={PigIcon} picture={problematic2Picture} tittle='El alto costo' content='En Bogotá el precio promedio de un apartaestudio, sin tener en cuenta administración y amoblado, es de $1.47M COP. En Roomatch, puedes ahorrar consiguiendo vivienda compartida, la cual es un 64% mas barata.' /></div>
          <div className='problematic__card'><Card modifier='2' icon={FriendsIcon} picture={problematic1Picture} tittle= 'Los estudiantes foráneos' content='Una encuesta de El Tiempo reveló que en Colombia el 57% de los estudiantes universitarios en Bogotá son foráneos. Queremos ayudarte a encontrar más gente como tú.' /></div>
          <div className='problematic__card'><Card modifier='3' icon={HomeIcon} picture={problematic3Picture} tittle='La convivencia' content='En una encuesta realizada por la CNN en el año 2023, reveló que el 84% de las personas que comparten vivienda con un amigo, reportó que se sentía que era más feliz. Por eso, en Roomatch  queremos lograr que;  además de un compañero, encuentres a un amigo.' /></div>
          <div className='problematic__card'><Card modifier='4' icon={AlternativeIcon} picture={problematic4Picture} tittle='Las otras alternativas' content='Actualmente hay alternativas como casas familiares y residencias. En estos lugares, la gente se ve obligada a convivir con gente al azar y algunas veces a someterse hasta a reglas absurdas y malos tratos. Queremos que encuentres personas compatibles contigo y que no te resten libertad.' /></div>
        </motion.div>
