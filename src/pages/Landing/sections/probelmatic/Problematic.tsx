  ...
  return (
    <div className='problematic-container' id='problematic'>
      ...
      className='problematic__cards-container'>
          ...
          <div className='problematic__card'><Card modifier='2' icon={FriendsIcon} picture={problematic1Picture} tittle= 'Los estudiantes foráneos' content='Una encuesta de El Tiempo reveló que en Colombia el 57% de los estudiantes universitarios en Bogotá son foraneos. Queremos ayudarte a encontrar más gente como tú.' /></div>
          <div className='problematic__card'><Card modifier='3' icon={HomeIcon} picture={problematic3Picture} tittle='La convivencia' content='En una encuesta realizada por la CNN el año 2023 se reveló que el 84% de la gente que comparte con un amigo reporto que sentia que era mas felíz, por eso, en Roomatch queremos lograr que, ademas de un compañero de cuarto, encuentres a un amigo.' /></div>
