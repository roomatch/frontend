  ...
  return (
    <div className='problematic-container'>
      ...
      className='problematic__cards-container'>
          ...
          <div className='problematic__card'><Card modifier='2' tittle= 'No estas solo' content='Una encuesta de El Tiempo reveló que en Colombia el 57% de los estudiantes universitarios en Bogotá son foraneos, por lo que sabemos que no estas solo y queremos ayudarte a encontrar a gente como tu' /></div>
          <div className='problematic__card'><Card modifier='3' tittle='Un hogar lo hace la gente' content='Vivir solo es bueno, pero ¡vivir con amigos es mejor! En una encuesta realizada por la CNN el año 2023 se reveló que el 84% de la gente que compartia casa o apartamento con un amigo reporto que sentia que era "mucho mas felíz", por eso, en Roomatch queremos lograr que, ademas de un compañero de cuarto, encuentres a un amigo' /></div>
          <div className='problematic__card'><Card modifier='4' tittle='Otras alternativas' content='La gente actualmente recurre a alternativas como casas familiares o residencias universitarias. En estos lugares la gente se ve obligada a convivir con gente al azar y debe someterse a reglas sobre las que no tienen voz ni voto. Por eso en Roomatch queremos que encuentres personas compatibles con tu estilo de vida que no te resten libertad' /></div>
        </motion.div>
